...
class BuildPacket(object):
    ...
    def GetParametersInHexForm(self, comand, parameters):
        if comand == CommandsList.echo:
            ...
            return self.typeConvertor.FloatToHex(parameters[0]) + self.typeConvertor.FloatToHex(
                parameters[1]) + self.typeConvertor.FloatToHex(parameters[2])
        elif comand == CommandsList.addPointToStack:
            return self.typeConvertor.FloatToHex(parameters[0]) + self.typeConvertor.FloatToHex(
                parameters[1]) + self.typeConvertor.FloatToHex(parameters[2]) + self.typeConvertor.IntToHex(
                parameters[3])
        elif comand == CommandsList.setMovementParameters:
            return self.typeConvertor.FloatToHex(parameters[0]) + self.typeConvertor.FloatToHex(
                parameters[1]) + self.typeConvertor.FloatToHex(parameters[2]) + self.typeConvertor.FloatToHex(
                parameters[3]) + self.typeConvertor.FloatToHex(parameters[4])
            ...
            return self.typeConvertor.FloatToHex(parameters[0]) + self.typeConvertor.FloatToHex(
                parameters[1]) + self.typeConvertor.FloatToHex(parameters[2]) + self.typeConvertor.FloatToHex(
                parameters[3]) + self.typeConvertor.FloatToHex(parameters[4]) + self.typeConvertor.FloatToHex(
                parameters[5]) + self.typeConvertor.IntToHex(parameters[6])
        return ""
